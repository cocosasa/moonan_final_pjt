<template>
  <div class="starpoint_wrap">
    <div class="starpoint_box">
      ...
      <input type="radio" name="starpoint" id="starpoint_5" class="star_radio" @click="setScore('2.5')">
      <input type="radio" name="starpoint" id="starpoint_6" class="star_radio" @click="setScore('3.0')">
...
background-size: 200px;}
.starpoint_box .label_star{display:inline-block;width:20px;height:40px;box-sizing:border-box;}
