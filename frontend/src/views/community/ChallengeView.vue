<template>
  <div>
    <h1 class="text-center my-2"><span class = "bold color-change" style = "font-size: 60px">Poster Challenge</span></h1>
    <h5 class = "text-center" style = "font-size: 20px">포스터 일부를 보고 영화를 맞혀보세요!</h5>
    <h3 class="text-center my-3 bold over-underline" v-if="currentScore != 0">정답 맞힐 시 {{currentScore}}점 획득</h3>
    <h3 class="text-center my-3" v-if="currentScore == 0">{{ randomMovie[0].title }}</h3>
    ...
    <div class="d-flex justify-content-center gap-5 my-3" v-if="currentScore!=0">
    ...
    <div v-if="currentScore == 0" class="d-flex justify-content-center gap-5 my-3">
